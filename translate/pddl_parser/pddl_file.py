...
from translate.pddl_parser.lisp_parser import parse_nested_list
from translate.pddl_parser.lisp_parser import ParseError
from translate.pddl_parser.parsing_functions import parse_task
from translate.pddl_parser.parsing_functions import parse_probabilistic_task
...
def open(domain_filename=None, task_filename=None, type='conformant_planning'): # type可以是conformant_planning或者conformant_probabilistic_planning
